...
data class PetCollectionResponse(

	@field:SerializedName("PetCollectionResponse")
	val petCollectionResponse: List<PetCollectionResponseItem>
)

data class PetCollectionResponseItem(
