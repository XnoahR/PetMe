...
<div class="flex-1 h-screen p-10 pt-20">
    <h1 class="text-pastel-custom text-5xl font-medium">Edit Notification</h1>
    <div class="flex justify-between mt-10">
        <a href="{{ route('notification.index') }}"><button class="font-bold bg-pastel-custom text-purple-custom rounded-xl p-2.5 px-4 hover:text-black"><i class="fas fa-arrow-left mr-2"></i>Back to List User</button></a>
    </div>
            ...
            <form action="{{ route('notification.update', $notif->id) }}" method="POST">
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <input type="text" name="title" id="nameNotif"
                        ...
                        placeholder="Name Notification" value="{{ old('title', $notif->title) }}">
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <textarea name="description" id="description"
                        ...
                        placeholder="Description Notification" maxlength="255">{{ old('description', $notif->description) }}</textarea>
                ...
                <div class="flex justify-end mt-5">
                    <button type="submit"
                        class="bg-purple-custom text-pastel-custom p-3 font-semibold rounded-xl hover:bg-pastel-custom hover:text-purple-custom px-7">Update Notification</button>
                </div>
            </form>
        </div>
    </div>
